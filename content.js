...
const content = {
	...
	<p>A <a href="https://colab.research.google.com/github/lcommons/portfolio/blob/master/Regression.ipynb">notebook</a> that deomnstrates linear regression an dlogistic regression using SKLearn, as well as pandas, numpy, and data visualization with Matplotlib and Seaborn.</p>'
}
